...
import { Loader2, ArrowRight, Mail, Lock, CircleUser, Eye, EyeOff, Menu, X, UserPlus } from 'lucide-react';
          ...
          >
            <div className="space-y-2 mb-8">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-white">
                Join <span className="inline-block border-b-2 border-white pb-1">Us</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
              {[
                { title: "AI-Powered Analysis", description: "Get intelligent insights into your data" },
                { title: "Real-Time Updates", description: "Stay informed with live data processing" },
                { title: "Secure Environment", description: "Your data is protected with enterprise-grade security" },
                { title: "24/7 Support", description: "Access help whenever you need it" },
              ].map((feature, index) => (
                <motion.div
                  key={index}
